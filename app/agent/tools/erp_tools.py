...
class ERPTools:
    ...
    def query_erp_by_po(self, args: QueryPurchaseOrderArgs):
        return self.erp_service.get_purchase_order(args.po_number)

    def search_erp_by_vendor(self, args: SearchPurchaseOrdersArgs):
